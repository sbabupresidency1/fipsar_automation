...
import com.fipsar.qa.listeners.ConsoleLoggingListener;
import com.fipsar.qa.util.MailingReport;
import com.fipsar.qa.utils.Directory;
import com.fipsar.qa.writers.CurrentRunPageWriter;
...
public class ProgramTestNG {
	...
	public static void main(String args[]) throws Exception {
		...
		ExecutionType=System.getProperty("fipsar.execution.parseq").trim();
