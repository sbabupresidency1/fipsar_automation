...
import com.fipsar.qa.faf.faf_patient.faf_patient_reusables;
	...
	public Object executeAction(WebDriver driver, WebElement element,
		...
		if(true){
			...
			case "SeparateDigitsAndAlphabets":
				com.fipsar.qa.commands.Manipulation.separateDigitsAndAlphabets(
						driver, inputData);
				break;
			...
			case "SikuliClick":
				...
				break;	
			case "LLSPatientLogin":
				lls_patient_reusables.patientLogin(driver);
				break;
			...
			case "LLSPortalSelection": // Patient, Provider or Pharmacy
				...
				break;		
			case "FAFPortalSelection": // Patient, Provider or Pharmacy
				faf_patient_reusables.regSelection(driver);
				break;	
			case "FAFPatientLogin":
				faf_patient_reusables.patientLogin(driver);
				break;
			case "TenDigitPhone": 				
